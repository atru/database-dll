...
namespace SevenZip
{
    ...
    public static class Formats
    {
        ...
        internal static readonly Dictionary<string, InArchiveFormat> InSignatureFormats =
            ...
            //^ 0x8001, 0x8801 or 0x9001 byte offset1
            ...
            internal static readonly Dictionary<InArchiveFormat, string> InSignatureFormatsReversed =
            new Dictionary<InArchiveFormat,string>
        	{
        	{InArchiveFormat.SevenZip,                                               "37-7A-BC-AF-27-1C"},
            {InArchiveFormat.GZip,                                                        "1F-8B-08"},
            {InArchiveFormat.Tar,                                                  "75-73-74-61-72"},
            //257 byte offset
            {InArchiveFormat.Rar,                                            "52-61-72-21-1A-07-00"},
            {InArchiveFormat.Zip,								                        "50-4B-03-04"},
            {InArchiveFormat.Lzma,							                        "5D-00-00-40-00"},
            {InArchiveFormat.Lzh,								                            "2D-6C-68"},
            //^ 2 byte offset
            {InArchiveFormat.Lzw,								                            "1F-9D-90"},
            {InArchiveFormat.Arj,								                            "60-EA"},
            {InArchiveFormat.BZip2,								                            "42-5A-68"},
            {InArchiveFormat.Cab,								                        "4D-53-43-46"},
            {InArchiveFormat.Chm,								                        "49-54-53-46"},
            {InArchiveFormat.Deb,	"21-3C-61-72-63-68-3E-0A-64-65-62-69-61-6E-2D-62-69-6E-61-72-79"},
            {InArchiveFormat.Iso,							                        "43-44-30-30-31"},
            //^ 0x8001, 0x8801 or 0x9001 byte offset
            {InArchiveFormat.Rpm,								                        "ED-AB-EE-DB"},
            {InArchiveFormat.Wim,						                    "4D-53-57-49-4D-00-00-00"},
            {InArchiveFormat.Udf,									                            "udf"},
            {InArchiveFormat.Mub,									                            "mub"},
            {InArchiveFormat.Xar,								                        "78-61-72-21"},
            //0x400 byte offset
            {InArchiveFormat.Hfs,								                            "48-2B"},
            {InArchiveFormat.XZ,							                        "FD-37-7A-58-5A"},
            {InArchiveFormat.Flv,							                                "46-4C-56"},
            {InArchiveFormat.Swf,							                                "46-57-53"},
            {InArchiveFormat.PE,							                                "4D-5A"},
            {InArchiveFormat.Elf,							                            "7F-45-4C-46"},
            {InArchiveFormat.Dmg,                                                              "78"},
            {InArchiveFormat.Vhd,                                         "63-6F-6E-65-63-74-69-78"}
        };
/*
        static Formats()
        {
